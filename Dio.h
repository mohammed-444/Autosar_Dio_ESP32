 ...
 * File Name: Dio.h
 *
 * Description: Header file for esp32 Microcontroller - Dio Driver
 *
...
#if ((COMPILER_AR_RELEASE_MAJOR_VERSION != DIO_AR_RELEASE_MAJOR_VERSION)\
 ||  (COMPILER_AR_RELEASE_MINOR_VERSION != DIO_AR_RELEASE_MINOR_VERSION)\
 ||  (COMPILER_AR_RELEASE_PATCH_VERSION != DIO_AR_RELEASE_PATCH_VERSION))
  #error "The AR version of Compiler.h does not match the expected version"
#endif

/* Software Version checking between Port_Cfg.h and Port.h files */
#if ((COMPILER_SW_MAJOR_VERSION != DIO_SW_MAJOR_VERSION)\
 ||  (COMPILER_SW_MINOR_VERSION != DIO_SW_MINOR_VERSION)\
 ||  (COMPILER_SW_PATCH_VERSION != DIO_SW_PATCH_VERSION))
...
typedef struct
{
	/* Member contains the ID of the pad*/
